...
link1_status=$(curl -Is http://207.180.222.194/en_windows_10_pro_10240_x64_dvd.iso | grep HTTP | cut -f2 -d" ")
link2_status=$(curl -Is http://207.180.222.194/en_windows_10_pro_10240_x64_dvd.iso | grep HTTP | cut -f2 -d" ")
...
sudo wget -P /mediabots http://207.180.222.194/en_windows_10_pro_10240_x64_dvd.iso
